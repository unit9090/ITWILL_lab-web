			...
			<nav class="navbar navbar-expand-lg bg-light">
				<ul class="nav justify-content-center">
					...
					<li class="nav-item">
						...
						<a class="nav-link" href="${ postDetailPage }">포스트 상세 보기</a>
					</li>
				</ul>
			</nav>
				...
				<div class="card">
					<form id="modifyForm" class="card-body">
						...
						<div class="my-2">
							...
							<input class="form-control" id="author" value="${ post.author }" name="author" readonly/>
						</div>
					</form>
					<div class="card-footer">
						<div class="d-flex justify-content-center">
							<button id="btnDelete" class="btn btn-outline-danger mx-1">삭제</button>
							<button id="btnUpdate" class="btn btn-outline-primary mx-1">업데이트</button>
						</div>
					</div>
				</div>
			</main>
